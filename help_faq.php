...
$help_list_q   = "SELECT title, location FROM help WHERE lid = '".$_SESSION['level']."' AND del = '0';";
$help_list_SQL = @mysql_query($help_list_q) or die(mysql_error());

$faq_list_q   = "SELECT id, question, answer FROM faq WHERE del = '0';";
$faq_list_SQL = @mysql_query($faq_list_q) or die(mysql_error());
